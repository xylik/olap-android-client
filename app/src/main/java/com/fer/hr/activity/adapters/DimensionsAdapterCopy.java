...
public class DimensionsAdapterCopy /*extends BaseExpandableListAdapter*/ {
...
//
//    public DimensionsAdapterCopy(Activity activity, HashMap<Integer, Dimension> dimensions) {
//        activity = activity;
